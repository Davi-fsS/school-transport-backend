...
class PointService():
    ...
    def create_point(self, point_name: str, point: CreatePoint):
        ...
        point_body = PointModel(name=f"Casa {point_name}", address=point.address, point_type_id=1, lat=coords["lat"], lng= coords["lng"] ,description=f"Endereço principal de {point_name}")
